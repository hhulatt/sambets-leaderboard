# SamBets — Rainbet wager leaderboard

Live at **https://sambetsrewards.com/**

A one-page static site showing a $250 monthly wager leaderboard for Rainbet
affiliate code **SAMBETS1**. Generated from the Forge Partners leaderboard
...
| Setting | Value |
| --- | --- |
| Affiliate code | `SAMBETS1` |
| Referral link | https://rainbet.com?r=sambets1 |
...
5. **Point the domain** at Netlify and wait for the TLS certificate. A new
   ...
   certificate is actually issued for `sambetsrewards.com` before telling anyone the
   site is live.
...
`creators/sambets.json` in the template repo. Edit that, re-run
`node new-creator.mjs sambets`, and copy the regenerated files over. The cycle
