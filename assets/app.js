/* SamBets — monthly Rainbet wager leaderboard.
   ...
   creators/sambets.json, which is also what writes them into
...
(() => {
  ...
  async function runSearch() {
    ...
    if (!match) {
      setResult(`No wagers found for "${query}" this cycle. Make sure you signed up with code SAMBETS1 and that the spelling matches exactly.`, 'miss');
      return;
    }
